...
def generate_health_data():
    ...
    # Create a DataFrame with synthetic health data
    ...
    return health_data  # <-- This line should be indented at the same level as the code above it
...
def generate_demographic_data():
    ...
    # Create correlations between income, poverty, and uninsured rates
    base_income = np.random.uniform(30000, 200000, len(zip_codes))

    # Sort incomes to create realistic patterns
    sorted_indices = np.argsort(base_income)

    # Create inverse patterns for poverty and uninsured rates
    ...
    # Create correlation between minority percentage and income
...
def generate_healthcare_access_data():
    ...
    # Get demographic data to create correlated healthcare access barriers
    demographic_data = generate_demographic_data()

    # Create correlations between income and healthcare access
    np.random.seed(42)  # For reproducibility
    ...
    # Create correlated healthcare access metrics
...
def generate_environmental_data():
    ...
    # Create correlated environmental metrics
